...
export const guard = document.querySelector('.js-guard');
export const buttonTop = document.querySelector('.js-button-top');
...
export const paginationDiv = document.querySelector('.js-pagination');
...
export const openModalTeamBtn = document.querySelector('[data-team-modal-open]');
export const closeModalTeamBtn = document.querySelector('[data-team-modal-close]');
